...
class SpareEditScreen extends StatefulWidget {
  const SpareEditScreen(
      {super.key,
  ...
  @override
  State<SpareEditScreen> createState() => _SpareEditScreenState();
}
...
class _SpareEditScreenState extends State<SpareEditScreen> {
  @override
  void initState() {
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) => SpareScreen(
                                ...
                                asset_group_id:
                                    widget.asset_group_id.toString())));
                  },
                ),
              ],
      ),
  ...
  String? _getQuantityErrorText(int index, String value) {
    ...
    final total =
        int.parse(value) + int.parse(spareDetails[index].spareStock.toString());
  ...
  Widget _buildSaveButton(BuildContext context) {
    return ElevatedButton(
      onPressed: () {
        ...
        // logger.i(validQuantities && selectedSpareParts.isNotEmpty);
