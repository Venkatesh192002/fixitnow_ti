...
class BreakdownTicketCountsModel {
  bool? isError;
  String? message;
  List<BreakdownCountReportLists>? breakdownReportLists;

  BreakdownTicketCountsModel(
      {this.isError, this.message, this.breakdownReportLists});

  BreakdownTicketCountsModel.fromJson(Map<String, dynamic> json) {
    isError = json['is_error'];
    message = json['message'];
    if (json['breakdown_reportLists'] != null) {
      breakdownReportLists = <BreakdownCountReportLists>[];
      json['breakdown_reportLists'].forEach((v) {
        breakdownReportLists!.add(BreakdownCountReportLists.fromJson(v));
      });
    }
  }
  BreakdownTicketCountsModel.fromError(
...
class BreakdownCountReportLists {
  int? ticketCount;
  int? assetCount;
  int? sumOfDowntime;
  int? open;
  ...
  BreakdownCountReportLists.fromJson(Map<String, dynamic> json) {
