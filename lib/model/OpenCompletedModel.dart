class OpenCompletedModel {
  bool? isError;
  String? message;
  List<BreakdownReportLists>? breakdownReportLists;

  OpenCompletedModel({this.isError, this.message, this.breakdownReportLists});

  OpenCompletedModel.fromJson(Map<String, dynamic> json) {
