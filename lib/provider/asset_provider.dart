...
class AssetProvider extends ChangeNotifier {
  ...
  EmployeeEngineerModel? _overallEngineerId;
  EmployeeEngineerModel? get overallEngineerId => _overallEngineerId;
  set overallEngineerId(EmployeeEngineerModel? val) {
    _overallEngineerId = val;
    notifyListeners();
  }
